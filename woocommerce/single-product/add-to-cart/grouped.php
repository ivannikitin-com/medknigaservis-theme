	...
	<section class="up-sells upsells products">
		...
		<?php woocommerce_product_loop_start(); ?>
			...
			<?php foreach ( $grouped_products as $grouped_product_child ) : ?>
				...
				wc_get_template_part( 'content', 'grouped-product' );
...
<?php 
$button_html = '<a href="'.$external_grouped_url.'" class="button" target="_blank">'.__('Купить комплект','medknigasevis').' за '.wc_price($external_grouped_price).'</a>'; 
//echo $button_html; ?>
